...
//	beep_Init();
	...
	USARTInit(USART2,US2_Rx, US2_Tx, 115200,1,1,uart2_sendBuff, uart2_recBuff,Length_USART2_RX_Buff);
	USARTInit(UART4,WIFI_Rx, WIFI_Tx, 115200,1,1,uart4_sendBuff, uart4_recBuff,Length_UART4_RX_Buff);
...
//	communicate_init();
	...
	TIM6_Int_Init(100-1,840-1);	//定时器时钟84M，分频系数840，所以84M/840=100Khz的计数频率，计数100次为1ms
}
//#pragma arm section
