...
void USART_RCC_Init(USART_TypeDef* USARTx, BSP_GPIOSource_TypeDef* USART_RX, BSP_GPIOSource_TypeDef *USART_TX, uint8_t DMA_en){
	...
	switch((int) GPIOx){
		case (int)GPIOA:GPIO_RCC = RCC_AHB1Periph_GPIOA;break;
		case (int)GPIOB:GPIO_RCC = RCC_AHB1Periph_GPIOB;break;
		case (int)GPIOC:GPIO_RCC = RCC_AHB1Periph_GPIOC;break;
		case (int)GPIOD:GPIO_RCC = RCC_AHB1Periph_GPIOD;break;
		case (int)GPIOE:GPIO_RCC = RCC_AHB1Periph_GPIOE;break;
		case (int)GPIOF:GPIO_RCC = RCC_AHB1Periph_GPIOF;break;
		case (int)GPIOG:GPIO_RCC = RCC_AHB1Periph_GPIOG;break;
		case (int)GPIOH:GPIO_RCC = RCC_AHB1Periph_GPIOH;break;
		case (int)GPIOI:GPIO_RCC = RCC_AHB1Periph_GPIOI;break;
		default:break;
	}
	...
	//串口时钟初始化
	switch((int)USARTx){
		case (int)USART1:RCC_APB2PeriphClockCmd(RCC_APB2Periph_USART1,ENABLE);break;
		case (int)USART2:RCC_APB1PeriphClockCmd(RCC_APB1Periph_USART2,ENABLE);break;
		case (int)USART3:RCC_APB1PeriphClockCmd(RCC_APB1Periph_USART3,ENABLE);break;	
		case (int)UART4:RCC_APB1PeriphClockCmd(RCC_APB1Periph_UART4,ENABLE);break;
		case (int)UART5:RCC_APB1PeriphClockCmd(RCC_APB1Periph_UART5,ENABLE);break;
		case (int)USART6:RCC_APB2PeriphClockCmd(RCC_APB2Periph_USART6,ENABLE);break;
		case (int)UART7:RCC_APB1PeriphClockCmd(RCC_APB1Periph_UART7,ENABLE);break;
		case (int)UART8:RCC_APB1PeriphClockCmd(RCC_APB1Periph_UART8,ENABLE);break;
		default:break;
	}
}
...
uint8_t get_USART_NVIC_IRQChannel(USART_TypeDef* USARTx){
	...
	switch((int)USARTx){
		case (int)USART1:NVIC_IRQChannel = USART1_IRQn;break;
		case (int)USART2:NVIC_IRQChannel = USART2_IRQn;break;
		case (int)USART3:NVIC_IRQChannel = USART3_IRQn;break;
		case (int)UART4:NVIC_IRQChannel = UART4_IRQn;break;
		case (int)UART5:NVIC_IRQChannel = UART5_IRQn;break;
		case (int)USART6:NVIC_IRQChannel = USART6_IRQn;break;
//		case (int)UART7:NVIC_IRQChannel = UART7_IRQn;break;
//		case (int)UART8:NVIC_IRQChannel = UART8_IRQn;break;
		default:break;
	}
