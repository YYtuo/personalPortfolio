...
#include "string.h"
/******************************外部调用函数************************************/
void BSP_FLASH_Write(uint32_t WriteAddr, uint32_t *pBuffer, uint32_t ByteToWrite);         //从指定地址开始写入指定长度的数据
void BSP_FLASH_Read(uint32_t ReadAddr,  uint32_t *pBuffer, uint32_t NumToRead);            //从指定地址开始读出指定长度的数据
/*****************************************************************************/
